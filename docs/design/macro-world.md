...
CLAIM_CHUNK_TILES = 32     # land is claimed in chunks this many tiles square
LINK_BUILD_PER_YEAR = 240  # planner: drawn corridors, cables and rails built at up to this many tiles a sim-year
HISTORY_EVERY = 4          # planner: a sample of a city's life every this many substeps (a sim-year)
HISTORY_SAMPLES = 150      # planner: how many samples a city keeps
CLAIM_FIRST_POPULATION = 200 # the first claim opens at this many people
CLAIM_STEP_POPULATION = 100  # and one more with every this many after
...
COST_LABORATORY = 120        LAB_POWER = 3            LAB_WATER = 1            LAB_RESEARCH = 12  # credits/yr
COST_ALGAE_REACTOR = 40      ALGAE_POWER = 2          ALGAE_WATER = 1          ALGAE_OXYGEN = 5
COST_SKYSCRAPER = 300        SKYSCRAPER_HOUSING = 160 SKYSCRAPER_POWER = 10    SKYSCRAPER_WATER = 7
SKYSCRAPER_OXYGEN = 7        SKYSCRAPER_FOOD = 7      SKYSCRAPER_PEOPLE = 1000 # built from 1,000 people
COST_OBSERVATORY = 400       OBSERVATORY_POWER = 5    OBSERVATORY_RESEARCH = 40 OBSERVATORY_PEOPLE = 2000
COST_STATION = 600           STATION_POWER = 4        STATION_PEOPLE = 5000    COST_RAIL = 2   # rails join stations' networks
COST_RESEARCH_FORUM = 500    FORUM_POWER = 6          FORUM_WATER = 3          FORUM_FOOD = 2
FORUM_RESEARCH = 30          FORUM_GROWTH_BONUS = 0.25 # growth rate x1.25 while one runs
COST_MEDICAL_CENTER = 350    MEDICAL_POWER = 4        MEDICAL_WATER = 2        MEDICAL_PEOPLE = 1000
MEDICAL_SHELTER = 400        # people each shelters from dying while oxygen or food runs short
COST_INDUSTRIAL_COMMAND = 450  COMMAND_POWER = 5      COMMAND_BOOST = 0.1      # facilities in its square make 10% more
COMMAND_SQUARE_TILES = 15    COMMAND_SQUARE_PER_LEVEL = 2
BUILD_YEARS_LABORATORY = 0.3   BUILD_YEARS_ALGAE_REACTOR = 0.2   BUILD_YEARS_SKYSCRAPER = 1     BUILD_YEARS_OBSERVATORY = 0.8
BUILD_YEARS_STATION = 1        BUILD_YEARS_RESEARCH_FORUM = 0.8  BUILD_YEARS_MEDICAL_CENTER = 0.6  BUILD_YEARS_INDUSTRIAL_COMMAND = 0.8
MAX_LEVEL_HABITAT_DOME = 5   MAX_LEVEL_REGOLITH_MINE = 10   MAX_LEVEL_OTHER = 8
COST_WIND_TURBINE = 35       WIND_POWER = 10          WIND_MIN_PRESSURE = 300  WIND_FULL_PRESSURE = 1000  # mbar: opens, and full output
COST_MEGA_MALL = 1500        MALL_FOOD = 90           MALL_POWER = 70          MALL_PEOPLE = 10000
COST_WATER_TANK = 25         TANK_WATER = 400         COST_BATTERY_BANK = 40   BATTERY_POWER = 150
COST_FREEZER = 30            FREEZER_FOOD = 400       FREEZER_POWER = 1
COST_MATERIALS_DEPOT = 30    MATERIALS_DEPOT_MATERIALS = 1500
COST_PARK = 20               PARK_OXYGEN = 2          PARK_WATER = 1           PARK_MIN_OPEN_AIR = 0.5  # share of the planet open to a mask
COST_BIOSPHERE = 800         BIOSPHERE_FOOD = 40      BIOSPHERE_OXYGEN = 30    BIOSPHERE_POWER = 20     BIOSPHERE_WATER = 12
BUILD_YEARS_WIND_TURBINE = 0.2  BUILD_YEARS_MEGA_MALL = 2   BUILD_YEARS_WATER_TANK = 0.1  BUILD_YEARS_BATTERY_BANK = 0.1
BUILD_YEARS_FREEZER = 0.1       BUILD_YEARS_MATERIALS_DEPOT = 0.2  BUILD_YEARS_PARK = 0.1  BUILD_YEARS_BIOSPHERE = 1.5
INTERCITY_ENABLED = 0        INTERCITY_COST_PER_KM = 5   INTERCITY_CARRY = 300   # railways between settlements: off by default; materials a km; a year's carry
